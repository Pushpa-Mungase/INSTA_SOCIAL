...
import { X, User, LogIn, UserPlus, Sparkles, Settings } from "lucide-react";
...
export default function Navbar() {
  ...
  const closeModal = () => {
   ...
   const handleSettingsClick = () => {
    // Open a modal or do whatever you need
...
<div className="flex items-center space-x-4">
  ...
  <span
    ...
    onClick={()=>{
      navigate("/setting",{state:{view:"setting"}});
    }}
  >
  ...
  <button
    ...
    className="text-white border !px-2 !py-0.5 rounded !bg-[#8e51ff] hover:!bg-purple-400"
  >
    Logout
  </button>
</div>
